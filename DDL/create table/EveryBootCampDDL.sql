...
-- 외래키 설정
ALTER TABLE LIBRARY ADD CONSTRAINT FOREIGN KEY (lib_member_id) REFERENCES member (member_id);
ALTER TABLE LIBRARY ADD CONSTRAINT FOREIGN KEY (lib_book_id) REFERENCES BOOK_INFO (book_id);
ALTER TABLE MEMBER_QUESTION ADD CONSTRAINT FOREIGN KEY (qst_member_id) REFERENCES MEMBER (member_id);
ALTER TABLE MEMBER_QUESTION ADD CONSTRAINT FOREIGN KEY (qst_id) REFERENCES QUESTION (qst_id);
ALTER TABLE STUDY_PARTICIPANT ADD CONSTRAINT FOREIGN KEY (study_page_id) REFERENCES STUDY_PAGE (study_page_id);
ALTER TABLE STUDY_PARTICIPANT ADD CONSTRAINT FOREIGN KEY (study_ptcp_id) REFERENCES member (member_id);
ALTER TABLE MENTEE_FROM_MENTORING ADD CONSTRAINT FOREIGN KEY (mfm_id) REFERENCES MENTORING (mtr_id);
ALTER TABLE MENTEE_FROM_MENTORING ADD CONSTRAINT FOREIGN KEY (menti_id) REFERENCES MEMBER (member_id);
